export default {
  ...
  chat: {
    ...
    updatingSessionContent: 'Sitzungsinhalt wird aktualisiert',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    xaiWaiting: 'Schließe die Autorisierung auf der geöffneten xAI-Seite ab. Dieses Fenster schließt sich nach der Genehmigung automatisch.',
    xaiOpenLink: 'xAI-Autorisierungsseite öffnen',
    xaiApproved: 'Anmeldung erfolgreich!',
    xaiExpired: 'Der Autorisierungslink ist abgelaufen. Bitte versuche es erneut.',
  ...
  runtime: {
    ...
    subtitle: 'Live-Status von Bridge-Runs und Sitzungszuordnungen aus der aktuellen TUI-Bridge.',
    refresh: 'Aktualisieren',
    refreshSuccess: 'Laufzeitstatus aktualisiert',
    bridgeEnabled: 'Bridge aktiviert',
    enabled: 'Aktiviert',
    disabled: 'Deaktiviert',
    activeRuns: 'Aktive Runs',
    trackedSessions: 'Verfolgte Sitzungen',
    pendingResolutions: 'Ausstehende Auflösungen',
    runsTitle: 'Run-Details',
    sessionsTitle: 'Bridge-Sitzungen',
    lastUpdated: 'Aktualisiert um {time}',
    noRuns: 'Keine aktiven oder verfolgten Runs',
    noSessions: 'Keine Bridge-Sitzungen erfasst',
    webSession: 'Web-Sitzung',
    bridgeSession: 'Bridge-Sitzung',
    persistentSession: 'Persistente Sitzung',
    activeRun: 'Aktiver Run',
    lastEvent: 'Letztes Ereignis',
    age: 'Alter',
    idle: 'Leerlauf',
    events: 'Ereignisse',
    contextTokens: 'Kontext-Token',
    notAvailable: 'n/v',
    runStatus: {
      running: 'Läuft',
      awaiting_approval: 'Wartet auf Freigabe',
      awaiting_clarify: 'Wartet auf Klärung',
  ...
  skillsUsage: {
    ...
    refresh: 'Aktualisieren',
    refreshSuccess: 'Skill-Nutzung aktualisiert',
