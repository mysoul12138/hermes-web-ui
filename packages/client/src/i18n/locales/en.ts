export default {
  ...
  runtime: {
    ...
    subtitle: 'Live bridge run and session mapping status from the current TUI bridge.',
    refresh: 'Refresh',
    refreshSuccess: 'Runtime status refreshed',
    ...
    runsTitle: 'Active run details',
    sessionsTitle: 'Bridge sessions',
    lastUpdated: 'Updated at {time}',
    noRuns: 'No active or tracked runs',
    noSessions: 'No bridge sessions tracked',
  ...
  skillsUsage: {
    ...
    refresh: 'Refresh',
    refreshSuccess: 'Skill usage refreshed',
