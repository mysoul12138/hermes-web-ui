export default {
  ...
  chat: {
    ...
    branchActiveHint: 'Child branch session uses its own context; you can keep sending or stop it.',
    branchTreeShowAll: '{count} older branches hidden. Show all',
    branchTreeShowLatest: 'Collapse tree to the latest 2 branches',
    ...
    busyInputWillSteer: 'This session is running; sending now injects /steer into the current turn.',
    busyInputWillQueue: 'This session is busy; sending now will queue the message.',
    busyInputQueued: '{count} queued message(s) will send after the current response.',
    ...
    clarifyTitle: 'Hermes needs your input',
    clarifyCustomPlaceholder: 'Type another answer',
    clarifySend: 'Send',
    clarifyResponding: 'Submitting answer...',
  ...
  settings: {
    ...
    display: {
      ...
      assistantAvatar: 'AI Reply Avatar',
      assistantAvatarHint: 'Upload an image for the AI reply avatar in chat (max 10MB, PNG/JPG/WebP supported)',
      uploadAvatar: 'Upload Avatar',
      resetAvatar: 'Reset',
      avatarInvalid: 'Please choose an image file',
      avatarHeicUnsupported: 'This browser cannot preview HEIC/HEIF directly; please convert it to PNG, JPG, or WebP first',
      avatarTooLarge: 'Image must be 10MB or smaller',
      showCost: 'Show Cost',
      ...
      busyInputModeHint: 'Allow /steer injection while AI is processing',
      theme: 'Theme',
    ...
    webui: {
      bridge: 'Enable Hermes TUI Bridge',
      bridgeHint: 'Route new WebUI chat requests through the Hermes TUI compatibility bridge; this setting overrides the startup environment',
      bridgeEnvDefault: 'Default from environment',
      bridgeEnvDefaultHint: 'The current default comes from HERMES_WEBUI_BRIDGE; after toggling, WebUI config takes over',
    },
  },
  ...
  platform: {
    ...
    qrExpiredHint: 'QR code expired, please request a new one',
  },
