export default {
  ...
  chat: {
    ...
    updatingSessionContent: '세션 내용을 업데이트하는 중',
  ...
  models: {
    ...
    xaiWaiting: '열린 xAI 페이지에서 인증을 완료하세요. 승인되면 이 창은 자동으로 닫힙니다.',
  ...
  runtime: {
    title: '실행 상태',
    subtitle: '현재 TUI bridge의 bridge 실행 및 세션 매핑 실시간 상태입니다.',
    refresh: '새로고침',
    refreshSuccess: '실행 상태를 새로고침했습니다',
    bridgeEnabled: 'Bridge 활성화',
    enabled: '활성화',
    disabled: '비활성화',
    activeRuns: '활성 실행',
    trackedSessions: '추적 세션',
    pendingResolutions: '대기 중인 해석',
    runsTitle: '실행 상세',
    sessionsTitle: 'Bridge 세션',
    lastUpdated: '{time}에 업데이트',
    noRuns: '활성 또는 추적 중인 실행이 없습니다',
    noSessions: '추적 중인 bridge 세션이 없습니다',
    webSession: 'Web 세션',
    bridgeSession: 'Bridge 세션',
    persistentSession: '영구 세션',
    activeRun: '활성 실행',
    lastEvent: '마지막 이벤트',
    age: '경과 시간',
    idle: '유휴',
  ...
  skillsUsage: {
    ...
    refresh: '새로고침',
    refreshSuccess: '스킬 사용량을 새로고침했습니다',
