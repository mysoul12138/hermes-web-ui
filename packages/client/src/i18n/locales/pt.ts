...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    xaiLoginTitle: 'Login OAuth do xAI Grok',
    xaiWaiting: 'Conclua a autorização na página xAI aberta. Esta janela será fechada automaticamente após a aprovação.',
    xaiOpenLink: 'Abrir página de autorização xAI',
    xaiApproved: 'Login bem-sucedido!',
  ...
  // Estado de execução
  runtime: {
    title: 'Estado de execução',
    subtitle: 'Estado ao vivo de execuções bridge e mapeamentos de sessão a partir do TUI bridge atual.',
    refresh: 'Atualizar',
    refreshSuccess: 'Estado de execução atualizado',
    bridgeEnabled: 'Bridge habilitado',
    enabled: 'Habilitado',
    disabled: 'Desabilitado',
    activeRuns: 'Execuções ativas',
    trackedSessions: 'Sessões rastreadas',
    pendingResolutions: 'Resoluções pendentes',
    runsTitle: 'Detalhes da execução',
    sessionsTitle: 'Sessões bridge',
    lastUpdated: 'Atualizado às {time}',
    noRuns: 'Nenhuma execução ativa ou rastreada',
    noSessions: 'Nenhuma sessão bridge rastreada',
    webSession: 'Sessão web',
    bridgeSession: 'Sessão bridge',
    persistentSession: 'Sessão persistente',
  ...
  skillsUsage: {
    ...
    refresh: 'Atualizar',
    refreshSuccess: 'Uso de habilidades atualizado',
