export default {
  ...
  models: {
    ...
    xaiWaiting: '開いた xAI ページで認可を完了してください。承認されるとこのウィンドウは自動的に閉じます。',
    xaiOpenLink: 'xAI 認可ページを開く',
    xaiApproved: 'サインインに成功しました！',
    xaiExpired: '認可リンクの有効期限が切れました。もう一度お試しください。',
    customBadge: 'カスタム',
    previewBadge: 'プレビュー',
    disabledBadge: '利用不可',
  ...
  runtime: {
    title: '実行状態',
    subtitle: '現在の TUI bridge から取得した bridge 実行とセッション対応のライブ状態です。',
    refresh: '更新',
    refreshSuccess: '実行状態を更新しました',
    bridgeEnabled: 'Bridge 有効',
    enabled: '有効',
    disabled: '無効',
    activeRuns: 'アクティブ実行',
    trackedSessions: '追跡セッション',
    pendingResolutions: '解決待ち',
    runsTitle: '実行詳細',
    sessionsTitle: 'Bridge セッション',
    lastUpdated: '{time} に更新',
    noRuns: 'アクティブまたは追跡中の実行はありません',
    noSessions: '追跡中の bridge セッションはありません',
    webSession: 'Web セッション',
    bridgeSession: 'Bridge セッション',
    persistentSession: '永続セッション',
    activeRun: 'アクティブ実行',
    lastEvent: '最新イベント',
    age: '経過時間',
    idle: 'アイドル',
