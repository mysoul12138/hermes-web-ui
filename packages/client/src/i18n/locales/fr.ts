export default {
  ...
  chat: {
    ...
    send: 'Envoyer',
    steerMessage: 'Guider',
    messageSteered: '/steer injecte',
    busyInputWillSteer: 'Cette session est en cours ; l’envoi injecte /steer dans le tour actuel.',
...
jobTriggered: 'Job declenche',
  ...
  memory: {
    title: 'Memoire',
    refresh: 'Actualiser',
    refreshSuccess: 'Memoire actualisee',
  ...
  settings: {
    ...
    display: {
      ...
      busyInputModeHint: 'Autoriser l’injection /steer pendant le traitement de l\'IA',
      busyInputModeQueue: 'File d\'attente',
      busyInputModeSteer: 'Injecter',
      theme: 'Theme',
