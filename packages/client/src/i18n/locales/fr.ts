export default {
  ...
  chat: {
    ...
    updatingSessionContent: 'Mise a jour du contenu de la session',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    xaiWaiting: 'Terminez l’autorisation sur la page xAI ouverte. Cette fenêtre se fermera automatiquement une fois approuvée.',
  ...
  runtime: {
    ...
    subtitle: 'État en direct des runs bridge et des correspondances de sessions depuis le TUI bridge actuel.',
    refresh: 'Actualiser',
    refreshSuccess: 'État d’exécution actualisé',
    bridgeEnabled: 'Bridge activé',
    enabled: 'Activé',
    disabled: 'Désactivé',
    activeRuns: 'Runs actifs',
    trackedSessions: 'Sessions suivies',
    pendingResolutions: 'Résolutions en attente',
    runsTitle: 'Détails des runs',
    sessionsTitle: 'Sessions bridge',
    lastUpdated: 'Mis à jour à {time}',
    noRuns: 'Aucun run actif ou suivi',
    noSessions: 'Aucune session bridge suivie',
    webSession: 'Session web',
    bridgeSession: 'Session bridge',
    ...
    idle: 'Inactif',
    events: 'Événements',
    contextTokens: 'Tokens de contexte',
    notAvailable: 'n/d',
    runStatus: {
      running: 'En cours',
      awaiting_approval: 'En attente d’approbation',
      awaiting_clarify: 'En attente de clarification',
  ...
  skillsUsage: {
    ...
    refresh: 'Actualiser',
    refreshSuccess: 'Utilisation des compétences actualisée',
