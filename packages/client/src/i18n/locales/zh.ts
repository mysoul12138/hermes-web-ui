export default {
  ...
  chat: {
    ...
    updatingSessionContent: '正在更新会话内容',
  ...
  runtime: {
    title: '运行状态',
    subtitle: '基于当前 TUI bridge 的实时运行、会话映射和待处理交互状态。',
    refresh: '刷新',
    refreshSuccess: '运行状态已刷新',
    bridgeEnabled: 'Bridge 已启用',
    enabled: '已启用',
    disabled: '已禁用',
    activeRuns: '活跃运行',
    trackedSessions: '跟踪会话',
    pendingResolutions: '待解析会话',
    runsTitle: '运行详情',
    sessionsTitle: 'Bridge 会话',
    lastUpdated: '更新时间 {time}',
    noRuns: '暂无活跃或跟踪中的运行',
    noSessions: '暂无 Bridge 会话映射',
    webSession: 'Web 会话',
    bridgeSession: 'Bridge 会话',
    persistentSession: '持久会话',
    activeRun: '活跃运行',
    lastEvent: '最近事件',
    age: '运行时长',
    idle: '空闲时长',
