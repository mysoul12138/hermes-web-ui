export default {
  ...
  chat: {
    ...
    branchActiveHint: '子分支会话使用独立上下文，可继续发送或停止。',
    branchTreeShowAll: '已折叠 {count} 个旧分支，展开全部',
    branchTreeShowLatest: '收起分支树，仅显示最新 2 个',
    ...
    messageQueued: '已排队',
    steerMessage: '微调',
    messageSteered: '已注入 /steer',
    busyInputWillSteer: '当前会话正在运行，发送后会作为 /steer 注入当前回合。',
    busyInputWillQueue: '当前会话忙碌，发送后会排队。',
    busyInputQueued: '已排队 {count} 条消息，将在当前回复结束后发送。',
    ...
    clarifyTitle: '需要你选择',
    clarifyCustomPlaceholder: '输入其他回答',
    clarifySend: '发送',
    clarifyResponding: '正在提交回答...',
    thinkingLabel: '思考过程',
  ...
  settings: {
    ...
    display: {
      ...
      assistantAvatar: 'AI 回复头像',
      assistantAvatarHint: '上传图片替换聊天中 AI 回复左侧头像（最大 10MB，支持 PNG/JPG/WebP）',
      assistantName: '助手名称',
      ...
      avatarHeicUnsupported: '当前浏览器无法直接预览 HEIC/HEIF，请先转换为 PNG、JPG 或 WebP',
      avatarTooLarge: '图片不能超过 10MB',
      showCost: '显示费用',
      ...
      busyInputModeHint: 'AI 处理中允许通过 /steer 注入微调提示',
      theme: '主题',
    ...
    webui: {
      bridge: '启用 Hermes TUI Bridge',
      bridgeHint: '使用 WebUI 兼容桥接到 Hermes TUI，会立即影响新的会话请求；此配置优先于启动环境变量',
      bridgeEnvDefault: '来自环境变量默认值',
      bridgeEnvDefaultHint: '当前默认值来自 HERMES_WEBUI_BRIDGE；手动切换后将由 WebUI 配置接管',
    },
  },
