export default {
  ...
  chat: {
    ...
    updatingSessionContent: 'Actualizando contenido de la sesion',
...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    xaiWaiting: 'Completa la autorización en la página de xAI abierta. Esta ventana se cerrará automáticamente al aprobarse.',
    xaiOpenLink: 'Abrir página de autorización de xAI',
    xaiApproved: '¡Inicio de sesión correcto!',
    xaiExpired: 'El enlace de autorización ha caducado. Inténtalo de nuevo.',
  ...
  runtime: {
    ...
    subtitle: 'Estado en vivo de ejecuciones bridge y mapeos de sesión desde el TUI bridge actual.',
    refresh: 'Actualizar',
    refreshSuccess: 'Estado de ejecución actualizado',
    bridgeEnabled: 'Bridge habilitado',
    enabled: 'Habilitado',
    disabled: 'Deshabilitado',
    activeRuns: 'Ejecuciones activas',
    trackedSessions: 'Sesiones seguidas',
    pendingResolutions: 'Resoluciones pendientes',
    runsTitle: 'Detalles de ejecución',
    sessionsTitle: 'Sesiones bridge',
    lastUpdated: 'Actualizado a las {time}',
    noRuns: 'No hay ejecuciones activas o seguidas',
    noSessions: 'No hay sesiones bridge registradas',
    webSession: 'Sesión web',
    bridgeSession: 'Sesión bridge',
    persistentSession: 'Sesión persistente',
    ...
    runStatus: {
      ...
      awaiting_clarify: 'Esperando aclaración',
  ...
  skillsUsage: {
    ...
    refresh: 'Actualizar',
    refreshSuccess: 'Uso de habilidades actualizado',
